...
y = instance_ratio,
col sep=comma,
] {failure_instance_breakdown_throughput_A.csv};
...
y = instance_ratio,
col sep=comma,
] {failure_instance_breakdown_throughput_T.csv};
\addlegendentry{\texttt{T}}
...
y = instance_ratio,
col sep=comma,
] {failure_instance_breakdown_throughput_V.csv};
\addlegendentry{\texttt{V}}
...
%\addplot+[mark=none, densely dashed,gray,line width=0.5pt] coordinates {(25,0) (25,1.1)};
...
\addplot+[mark=none, densely dashed,gray,line width=0.5pt] coordinates {(25,0) (25,1.1)};
\addplot+[mark=none, densely dashed,gray,line width=0.5pt] coordinates {(75,0) (75,1.1)};
\addplot+[mark=none, densely dashed,gray,line width=0.5pt] coordinates {(125,0) (125,1.1)};
\addplot+[mark=none, densely dashed,gray,line width=0.5pt] coordinates {(175,0) (175,1.1)};
