...
y = instance_ratio,
col sep=comma,
] {failure_instance_breakdown_timer_retx_A.csv};
...
y = instance_ratio,
col sep=comma,
] {failure_instance_breakdown_timer_retx_T.csv};
...
y = instance_ratio,
col sep=comma,
] {failure_instance_breakdown_timer_retx_V.csv};
...
\addplot+[mark=none, densely dashed,gray,line width=0.5pt] coordinates {(0.5,0) (0.5,1.1)};
\addplot+[mark=none, densely dashed,gray,line width=0.5pt] coordinates {(1.5,0) (1.5,1.1)};
