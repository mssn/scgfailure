...
\node[right, text=myred] at (axis cs:22,0) {\bf 73.1\%};
\node[right, text=myred] at (axis cs:22,1) {\bf 100\%};
\node[right, text=myred] at (axis cs:22,2) {\bf 75.0\%};
\node[right, text=myred] at (axis cs:22,3) {\bf 77.8\%};
\node[right, text=myred] at (axis cs:22,4) {\bf 31\%};

%\legend{RA,RT,T310,SYNC,CONF}
