...
\pgfplotstableread{
lw lq med  uq uw
99.3	148.4	203.8	253.3	292.7
139.7	218.6	306.1	381.9	445.5
32.2	79	135.4	185.1	237.6
81.8	159	218.6	304.9	374.9
130.2	229.2	343.2	406.4	464.4
11.6	129.2	195.3	242.1	281.6
0.1	0.2	0.4	0.8	1.8
0.2	0.4	0.8	1.7	5.3
0.3	0.9	2.8	35.6	93
}\datatable
%%0.3	0.9	2.8	35.6	303
...
%		every whisker/.style={thick,black,solid},
...
%		every median/.style={very thick,blue,solid},},
	...
	every whisker/.style={thick,mypurple,solid},
...
%\node[] at (axis cs: 2,1000) {\normalsize {459}};
%\node[] at (axis cs: 5,1000) {\normalsize {694}};
%\node[] at (axis cs: 8,1000) {\normalsize {NULL}};
%
