...
] {failure_fd_sample_type_wl_1008_what_if_study_parameter_setting_stat.csv};

\addplot+[only marks,mark=o,densely dashed,mark options={scale=2},text mark as node=true,color=myred] coordinates {
	(8.49, 4.17)
};
\draw[line width=0.3mm,->, myred,dashed] (axis cs:8.49,45) to (axis cs:8.49,13);
\node[myred] at (axis cs: 8.49,55) {\normalsize $k=5$,$h=20$};
