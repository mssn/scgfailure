...
\pgfplotstableread[col sep = comma]{unnecessary-e1-20231006-132512_fd-p3-r1-t-sfm.csv}\cellsettablesfm
...
\addplot[
	...
	\addplot+[mark=none, dashed,mygreen,line width=0.5pt] coordinates {(10,184) (30,184)};
	
	\addplot+[mark=none, dashed,myred,line width=0.5pt] coordinates {(10,5.7) (30,5.7)};
	
	\draw[mygreen,<->,line width=0.5pt]  (axis cs:12,5.7) -- (axis cs: 12,184);
	
	\node[mygreen,right] at (axis cs: 11.5,259.5) {\small \bf 178Mbps};
	\node[mygreen,right] at (axis cs: 13,209.5) {\small \bf (31.2x)};  
	
	\addplot+[mark=none, dotted, line width=1.5pt,gray!50t] coordinates {(10,0) (10,400)};
	\node[shape aspect=1,diamond,draw = black, line width=1pt, fill=black!50, rotate=45]  at (axis cs: 10,355){};
