...
\pgfplotstableread[col sep = comma]{recovery-failure-e1_20210805-224651_5-a-scan-H-processed-sfm.csv}\cellsettablesfm
...
\addplot[
	...
	table[x=time_delta,y=thput_sfm]      from \cellsettablesfm;
...
\addplot[
	...
	\addplot+[mark=none, dotted,mypurple,line width=1.5pt, draw opacity=0.3] coordinates {(9.5,0) (9.5,200)};
	\addplot+[mark=none, dotted,mypurple,line width=1.5pt] coordinates {(12.1,0) (12.1,200)};
	\addplot+[mark=none, dotted,mypurple,line width=1.5pt, draw opacity=0.3] coordinates {(14.5,0) (14.5,200)};
	\addplot+[mark=none, dotted,mypurple,line width=1.5pt, draw opacity=0.3] coordinates {(17.2,0) (17.2,200)};
	\addplot+[mark=none, dotted,mypurple,line width=1.5pt, draw opacity=0.3] coordinates {(19.7,0) (19.7,200)};
	\addplot+[mark=none, dotted,mypurple,line width=1.5pt, draw opacity=0.3] coordinates {(22.3,0) (22.3,200)};
	\addplot+[mark=none, dotted,mypurple,line width=1.5pt, draw opacity=0.3] coordinates {(24.8,0) (24.8,200)};
	\addplot+[mark=none, dotted,mypurple,line width=1.5pt, draw opacity=0.3] coordinates {(27.4,0) (27.4,200)};
	\addplot+[mark=none, dotted,mypurple,line width=1.5pt, draw opacity=0.3] coordinates {(30,0) (30,200)};
	...
	\addplot+[mark=none, dashed,mygreen,line width=0.5pt] coordinates {(12.1,111.6) (30,111.6)};
	
	\addplot+[mark=none, dashed,myred,line width=0.5pt] coordinates {(12.1,79.1) (30,79.1)};
	
	\draw[mygreen,<->,line width=0.5pt]  (axis cs:14,79.1) -- (axis cs: 14,111.6);
	
	\node[mygreen,right] at (axis cs: 12.5,155) {\small \bf 33Mbps};  
	\node[mygreen,right] at (axis cs: 14.5,125) {\small \bf (42\%)};  
	
	\addplot+[mark=none, dotted, line width=1.5pt,gray!50t] coordinates {(12.1,0) (12.1,400)};
	\node[shape aspect=1,diamond,draw = black, line width=1pt, fill=black!50, rotate=45]  at (axis cs: 12.1,182){};
