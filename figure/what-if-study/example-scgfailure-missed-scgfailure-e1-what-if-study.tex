...
\pgfplotstableread[col sep = comma]{missed-e1-20230430-100900_c2-t-h-sfm.csv}\cellsettablesfm
...
\addplot[
	...
	\addplot+[mark=none, dashed,mygreen,line width=0.5pt] coordinates {(7.2,270.5) (30,270.5)};
	
	\addplot+[mark=none, dashed,myred,line width=0.5pt] coordinates {(7.2,46.5) (30,46.5)};
	
	\draw[mygreen,<->,line width=0.5pt]  (axis cs:9,46.5) -- (axis cs: 9,270.5);
	
	\node[mygreen,right] at (axis cs: 9.5,350) {\small \bf 224Mbps};
	\node[mygreen,right] at (axis cs: 11.5,300) {\small \bf (4.8x)};  
	
	\addplot+[mark=none, dotted, line width=1.5pt,gray!50t] coordinates {(7.2,0) (7.2,500)};
	\node[shape aspect=1,diamond,draw = black, line width=1pt, fill=black!50, rotate=45]  at (axis cs: 7.2,442){};
