...
] {thput_gain_ratio_u_cdf_indy_A.csv};
...
%x expr = \thisrowno{0},
%y expr = \thisrowno{1}* 100,
%] {thput_gain_ratio_u_cdf_indy_T.csv};
...
x expr = \thisrowno{0},
y expr = \thisrowno{1}* 100,
] {thput_gain_ratio_u_cdf_indy_V.csv};
...
x expr = \thisrowno{0},
y expr = \thisrowno{1}* 100,
] {thput_gain_ratio_u_cdf_wl_A.csv};
...
x expr = \thisrowno{0},
y expr = \thisrowno{1}* 100,
] {thput_gain_ratio_u_cdf_wl_T.csv};
